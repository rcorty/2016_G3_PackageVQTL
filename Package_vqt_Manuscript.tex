...
Correspondingly, several groups have proposed statistical methods for mapping QTL controlling the extent of this residual variance, these sometimes termed ``variance QTL'' (vQTL) \citep{Pare2010,Ronnegard2011a,Ronnegard2012,Cao2014,Soave2017,Dumitrascu2018}.
...
% \WV{}{Should we be using ``R/vqtl'' and ``R/qtl'' terminology?}
%
%In two companion articles, we characterize the method and competitors in the setting where variance heterogeneity is driven by a background factor (\citep{CortyValdar2018bvh-biorxiv}),  and use it to discover new QTL from two existing data resources (\CortyReanalysisPaper).
%
